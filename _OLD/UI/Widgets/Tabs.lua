...
local function UpdateTabVisual(tabIndex, isActive)
  ...
  if isActive then
    if bg then bg:SetTexture(AutoLFM.Core.Constants.TEXTURE_PATH .. "Tabs\\BottomTabActive") end
    ...
    if bg then bg:SetTexture(AutoLFM.Core.Constants.TEXTURE_PATH .. "Tabs\\BottomTabInactive") end
